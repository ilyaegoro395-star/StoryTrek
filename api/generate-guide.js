...
Оформление: абзацы через пустую строку, 4-6 предложений в абзаце, начинай с пространственного ориентира.
СТРОГО ЗАПРЕЩЕНО: звёздочки, решётки, тире-списки, любая markdown-разметка — только чистый связный текст.`;
